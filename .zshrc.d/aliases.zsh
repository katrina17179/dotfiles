...
alias red="kitty @ set-colors --all ~/.config/kitty/themes/Cyberpunk.conf"
alias neon="kitty @ set-colors --all ~/.config/kitty/themes/Neowave.conf"
alias rei="kitty @ set-colors --all ~/.config/kitty/themes/eva_unit_00_rei.conf"
alias red-perm="ln -sf ~/.config/kitty/themes/Cyberpunk.conf ~/.config/kitty/current-theme.conf && kitty @ set-colors --all ~/.config/kitty/current-theme.conf"
alias neon-perm="ln -sf ~/.config/kitty/themes/Neowave.conf ~/.config/kitty/current-theme.conf && kitty @ set-colors --all ~/.config/kitty/current-theme.conf"
