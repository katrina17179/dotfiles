...
alias red="ln -sf ~/.config/kitty/themes/Cyberpunk.conf ~/.config/kitty/current-theme.conf && kitty @ set-colors --all ~/.config/kitty/current-theme.conf"
alias neon="ln -sf ~/.config/kitty/themes/Neowave.conf ~/.config/kitty/current-theme.conf && kitty @ set-colors --all ~/.config/kitty/current-theme.conf"
